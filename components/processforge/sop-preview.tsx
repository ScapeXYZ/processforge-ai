...
export function generateMockSop(values: SopFormValues, revision = 1): Sop {
  ...
  return {
    title: `${title} — Standard Operating Procedure`, documentId: `PF-${idSeed}-${String(100 + revision).padStart(3, "0")}`, version: `1.${revision - 1}`, readinessScore: Math.min(96, 86 + revision), estimatedCompletionTime: values.detailLevel === "concise" ? "10–15 minutes" : values.detailLevel === "detailed" ? "25–35 minutes" : "15–25 minutes",
