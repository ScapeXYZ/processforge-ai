...
assert(String(requirement.amount) === String(pricing?.amount), `402 amount mismatch: received amount ${JSON.stringify(requirement?.amount)}, metadata amount ${JSON.stringify(pricing?.amount)}`);
