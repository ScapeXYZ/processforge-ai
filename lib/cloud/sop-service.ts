...
export async function fetchSops(): Promise<CloudResult<CloudSop[]>> {
  ...
  const workspaceId = getActiveWorkspaceId(); if (workspaceId) query = query.eq("workspace_id", workspaceId);
