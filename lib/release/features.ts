...
export const releaseFeatures: ReleaseFeature[] = [
  ...
  { name: "Workspaces and permissions", status: "review", steps: "Verify owner/admin/editor/viewer access to SOPs, comments, review workflow, members, and destructive actions." },
  { name: "Invitation email delivery", status: "out-of-scope", steps: "Do not advertise or release-test email delivery; invitations are intentionally excluded from this release." },
