...
export type Database = {
  public: {
    Tables: {
      ...
      sops: {
        Row: { id: string; user_id: string; workspace_id: string; title: string; industry: string | null; department: string | null; description: string | null; audience: string | null; detail_level: string | null; status: string; content: Json; readiness_score: number | null; input_quality_score: number | null; source_notes: Json | null; knowledge_source_names: string[]; is_favorite: boolean; is_archived: boolean; created_at: string; updated_at: string };
        Insert: { id?: string; user_id: string; workspace_id: string; title: string; industry?: string | null; department?: string | null; description?: string | null; audience?: string | null; detail_level?: string | null; status?: string; content: Json; readiness_score?: number | null; input_quality_score?: number | null; source_notes?: Json | null; knowledge_source_names?: string[]; is_favorite?: boolean; is_archived?: boolean; created_at?: string; updated_at?: string };
        Update: { title?: string; industry?: string | null; department?: string | null; description?: string | null; audience?: string | null; detail_level?: string | null; status?: string; content?: Json; readiness_score?: number | null; input_quality_score?: number | null; source_notes?: Json | null; knowledge_source_names?: string[]; is_favorite?: boolean; is_archived?: boolean; updated_at?: string };
        Relationships: [];
      };
      sop_versions: {
